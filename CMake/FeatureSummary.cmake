...
if (OGRE_BUILD_RENDERSYSTEM_GLES)
	set(_rendersystems "${_rendersystems}  + OpenGL ES 1.x [DEPRECATED]\n")
endif ()
...
var_to_string(OGRE_CONFIG_CONTAINERS_USE_CUSTOM_ALLOCATOR _containers DEPRECATED)
var_to_string(OGRE_CONFIG_DOUBLE _double)
var_to_string(OGRE_CONFIG_NODE_INHERIT_TRANSFORM _inherit_transform)
var_to_string(OGRE_CONFIG_MEMTRACK_DEBUG _memtrack_debug DEPRECATED)
var_to_string(OGRE_CONFIG_MEMTRACK_RELEASE _memtrack_release DEPRECATED)
var_to_string(OGRE_CONFIG_STRING_USE_CUSTOM_ALLOCATOR _string DEPRECATED)
...
set(_node_storage "map [DEPRECATED]")
else ()
set(_node_storage "vector")
endif ()
